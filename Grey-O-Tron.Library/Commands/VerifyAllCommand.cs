...
{
    [Command("gw2-verify-all", CommandDescription = "[DEPRECATED]: Had to disable this command because various api's can't handle the massive requests generated by this command in a short time.", CommandOptions = CommandOptions.DiscordServer | CommandOptions.RequiresAdmin)]
        ...
        public async Task Execute(SocketMessage message, CancellationToken cancellationToken)
        {
            ...
            if (message.Author is SocketGuildUser guildUser)
            {
                await guildUser.SendMessageAsync(
                    "This command is now [DEPRECATED] please rely on the bot to verify all users every night.");
